...
public class UserFileAction {
	...
	public static List<UserFileExt> getUserFoldChildren(String userFoldParentId) {
		...
		try {
			...
			LogManager.mariadbLog.error("查询文件夹子集失败", e);
			return null;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static List<UserFileExt> getRecycleBinUserFile(String userFoldTopId) {
		...
		try {
			...
			LogManager.mariadbLog.error("查询回收站文件失败", e);
			return null;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static UserFileExt getUserFile(String userFileId) {
		...
		try {
			...
			LogManager.mariadbLog.error("查询文件失败", e);
			return null;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static UserFileExt createUserFile(String userFileName, String userFoldParentId, String createUserId, String fileBaseMd5, long fileBaseTotalSize, FileBase fileBase) {
		...
		try {
			...
			LogManager.mariadbLog.error("创建文件失败", e);
			if (userFile.getFileBase() != null) {
	...
	public static boolean changeFileBase(String userFileId, String fileBaseId) {
		...
		try {
			...
			if (result != 1) {
				LogManager.mariadbLog.warn("修改文件失败");
				return false;
			}
			sqlSession.commit();
		} catch (Exception e) {
			...
			LogManager.mariadbLog.error("修改文件异常", e);
			return false;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static boolean updateFile(File file, File chunkFile) {
		...
		try {
			...
			LogManager.httpLog.error("修改文件失败", e);
			return false;
		} finally {
			if (fileInputStream != null) {
				try {
					...
					LogManager.httpLog.error("关闭块文件输入流失败", e);
				}
			}
			if (fileOutputStream != null) {
				try {
					...
					LogManager.httpLog.error("关闭输出流失败", e);
				}
			}
		}
	}
	...
	public static boolean updateUserFile(UserFileExt userFile, int uploadLength) {
		...
		try {
			...
			if (result != 1) {
				LogManager.mariadbLog.warn("修改基础文件失败");
				return false;
			}
			sqlSession.commit();
		} catch (Exception e) {
			...
			LogManager.mariadbLog.error("修改基础文件异常", e);
			return false;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static String createFile(String fileName) {
		...
		try {
			...
			LogManager.httpLog.error("创建文件异常", e);
			return null;
		}
	}
	...
	public static boolean deleteFile(String fileBaseRealPath) {
		...
		try {
			...
			LogManager.httpLog.error("删除文件异常", e);
			return false;
		}
	...
	public static boolean createFold(String name) {
		...
		try {
			...
			LogManager.httpLog.error("创建文件夹异常", e);
			return false;
		}
	...
	public static boolean clearRecycleBin(String userFoldTopId) {
		...
		try {
			...
			LogManager.mariadbLog.error("清空回收站失败", e);
			return false;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static boolean updateUserFileListState(List<String> userFileIds, int userFileState) {
		...
		try {
			...
			LogManager.mariadbLog.error("修改文件状态失败", e);
			return false;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
	...
	public static boolean updateUserFileListParentId(List<String> userFileIds, String userFoldParentId) {
		...
		try {
			...
			LogManager.mariadbLog.error("修改父类文件夹异常", e);
			return false;
		} finally {
			if (sqlSession != null) {
				sqlSession.close();
